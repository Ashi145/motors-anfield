...
function Hero() {
  ...
  return (
    <section ref={ref} className="media-dark noise relative flex min-h-[100svh] flex-col overflow-hidden bg-ink">
      {/* background */}
          ...
          {items.map((b, i) => (
            <Reveal key={b.name} delay={i * 0.1}>
              <Link to="/brands" className="group block">
                <div className="media-dark relative aspect-[4/5] overflow-hidden border border-line">
                  <img
                    src={b.img}
                    alt={b.name}
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-6">
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      ...
                      <span className="flex h-11 w-11 items-center justify-center border border-bone/20 text-bone transition-all duration-300 group-hover:border-blood group-hover:bg-blood">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        ...
        <div className="mt-14 grid gap-3 md:grid-cols-12">
          {visualGallery.map((item, index) => (
            ...
            >
              <figure className="media-dark group relative h-[300px] overflow-hidden bg-ink md:h-[410px]">
                <img
                  src={item.src}
                  alt={item.title}
                  loading="lazy"
  ...
  return (
    <section ref={ref} className="border-y border-line bg-coal">
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-24 md:py-32 lg:grid-cols-2">
        <Reveal>
          <div className="media-dark relative overflow-hidden border border-line">
            <motion.img
              style={{ y: imgY }}
