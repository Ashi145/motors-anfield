...
export default function DiagnosticTerminal() {
  ...
  return (
    <div className="media-dark relative overflow-hidden border border-line bg-panel shadow-[0_40px_80px_-20px_rgba(0,0,0,0.8)]">
      {/* scanline */}
      ...
      <div className="flex items-center justify-between border-b border-line bg-ink px-5 py-3">
        ...
        <p className="truncate font-mono text-[10px] uppercase tracking-[0.3em] text-smoke">
